...
#else
    char *xcol = _strdup("X_IMAGE");       // This is the column for the x-coordinates
    char *ycol = _strdup("Y_IMAGE");       // This is the column for the y-coordinates
    char *magcol = _strdup("MAG_AUTO");    // This is the column for the magnitude
    char *colFormat = _strdup("1E");       // This Format means a decimal number
    char *colUnits = _strdup("pixels");    // This is the unit for the xy columns in the file
    char *magUnits = _strdup("magnitude"); // This is the unit for the magnitude in the file
#endif
